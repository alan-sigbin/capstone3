...
const appt = appointments.map( indiv_appt =>
    ...
    <tr>
        ...
        <td className="f12">{indiv_appt.appt_client.guestname}</td>
...
return (
    ...
    (<Fragment>
            <div className="container-fluid mt-5 py-5 ">
                <div className="row">
                <h2 className="mx-5 px-5">Manage Appointments</h2>
                <Table striped bordered hover responsive size="sm">
                    <thead>
                        <tr>
                            <th>Appointment code</th>
                            <th className="f12">Appointment Date</th>
                            <th className="f12">Client</th>
                            <th className="f12">Service Name</th>
                            <th className="f12">Service Code</th>
                            <th className="f12">Status</th>
                            <th className="f12">Price</th>
                            <th className="f12">Pickup</th>
                            <th className="f12">Laborvalue</th>
                        </tr>
                    </thead>
                    {appt}
                </Table>
